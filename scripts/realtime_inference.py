...
class Avatar:
    ...
    def init(self):
        if self.preparation:
            # When preparation=True, always create/recreate the avatar cache
            # No prompting needed - the API decides when to recreate
            if os.path.exists(self.avatar_path):
                print(f"🔄 Recreating avatar cache: {self.avatar_id}")
            ...
            # When preparation=False, load existing cache
